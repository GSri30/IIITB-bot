...
body {font-family: 'Muli', sans-serif;}
    ...
    <tbody>
      <tr>
        <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 30px">Thanks for signing up to IIITB discord server!&nbsp;</span></div><div></div></div></td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:0px 0px 30px 0px;" role="module-content" bgcolor="6E6E6E">
                                          ...
                                          <div class="Unsubscribe--addressLine"><p>This is an auto-generated email. DO NOT reply to this email.</p><div class="Unsubscribe--addressLine"><p>IIITB Bot</p><p style="font-size:12px; line-height:20px;"><span class="Unsubscribe--senderAddress">iiitbbot@iiitb.org</span>, <span class="Unsubscribe--senderCity">Bangalore</span>, <span class="Unsubscribe--senderState">Karnataka</span></p></div>
        ...
        <tr>
          <td align="center" bgcolor="" class="outer-td" style="padding:0px 0px 20px 0px;">
            <table border="0" cellpadding="0" cellspacing="0" class="wrapper-mobile" style="text-align:center;">
              <tbody>
                <tr>
                <td align="center" bgcolor="#f5f8fd" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;"><a href="https://zense.co.in/" style="background-color:#f5f8fd; border:1px solid #f5f8fd; border-color:#f5f8fd; border-radius:25px; border-width:1px; color:#a8b9d5; display:inline-block; font-size:10px; font-weight:normal; letter-spacing:0px; line-height:normal; padding:5px 18px 5px 18px; text-align:center; text-decoration:none; border-style:solid; font-family:helvetica,sans-serif;" target="_blank">♥ POWERED BY Zense-IIITB</a></td>
                </tr>
              </tbody>
            </table>
          </td>
